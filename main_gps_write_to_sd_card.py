...
def setup():
  global base_tfcard, gpsv11_0, time,label0, label1, label2,status,curr_velocity_knots,INIT,RUNNING,PAUSE,GPS_READY,gps_log_object,gps_data_list,file_exists
  ...
  print(os.listdir('/sd/'))
  label0 = Widgets.Label("0:0:0", 35, 40, 1.0, 0xffffff, 0x000000, Widgets.FONTS.DejaVu18)
...
def loop():
  ...
  global base_tfcard, gpsv11_0, time, label0, label1,label2,status,INIT,RUNNING,PAUSE,curr_velocity_knots,curr_GPS_state,gps_data_list,file_exists
